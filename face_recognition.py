...
class Face_Recognition:
    def __init__(self, root):
        ...
        img_bottom = Image.open(
            r"Image\Group 73.png")
        img_bottom = img_bottom.resize((800, 620), Image.BILINEAR)
        self.photoimg_bottom = ImageTk.PhotoImage(img_bottom)

        f_lbl = Label(self.root, image=self.photoimg_bottom)
        f_lbl.place(x=100, y=180, width=1250, height=600)

        # =========== Button =====================
        b1_1 = Button(self.root, text="TAKE ATTENDANCE", command=self.face_recog, cursor="hand2", font=(
            "arial", 18, "bold"), bg="#2E75E9", fg="white")
