...
class Student:
    def __init__(self, root):
        ...
        Left_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,
                                text="Student Details", font=("lato", 12, "bold"))
        ...
        Class_Student_course_frame = LabelFrame(
            main_frame, bd=2, bg="white", relief=RIDGE, text="Class Student Information", font=("lato", 12, "bold"))
        ...
        studentName_entry = ttk.Entry(
            Class_Student_course_frame, textvariable=self.var_stu_name, width=20, font=("lato", 13, "bold"))
        ...
        division_combo = ttk.Combobox(Class_Student_course_frame, textvariable=self.var_div, font=(
            "lato", 13, "bold"), state="read only", width=18)
        ...
        # ============= Search system =============
        Search_frame = LabelFrame(Right_frame, bd=2, bg="white",
                                  relief=RIDGE, text="Search System", font=("lato", 12, "bold"))
        Search_frame.place(x=5, y=130, width=660, height=70)

        search_label = Label(Search_frame, text="Search By:", font=(
            "lato", 15, "bold"), bg="green", fg="white")
        search_label.grid(row=0, column=0, padx=10, pady=5, sticky=W)

        # Check box
        search_combo = ttk.Combobox(Search_frame, font=(
            "lato", 12, "bold"), state="read only", width=15)
        search_combo['values'] = (
        ...
        search_entry = ttk.Entry(
            Search_frame, width=13, font=("lato", 13, "bold"))
