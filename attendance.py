...
class Attendance:
    def __init__(self, root):
        ...
        Left_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,
                                text="Student Attendance Details", font=("lato", 14, "bold"))
        Left_frame.place(x=0, y=0, width=750, height=580)

        img_left = Image.open(
            r"Image\smart-attendance.jpg")
        ...
        left_inside__frame = LabelFrame(
            Left_frame, bd=2, bg="white", relief=RIDGE, font=("lato", 14, "bold"))
        ...
        studentName_entry = ttk.Entry(
            left_inside__frame, width=20, textvariable=self.var_atten_name, font=("lato", 13, "bold"))
        ...
        Right_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE,
                                 text="Attendance Details", font=("lato", 14, "bold"))
